<?php
 ...
 if($_POST){
  //print_r($_POST);
    ...
    $sentencia=$connection->prepare("SELECT *,count(*) as n_user FROM tbl_login
    WHERE  user=:user
    ...
    <!-- place navbar here -->
       <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
           <div class="container-fluid">
               <a class="navbar-brand" href="../index.php"> Regresar WebSite</a>
        ...
        <div class="card"style="background-color: gainsboro">
          ...
          <div class="card-body">
           ...
           <form action="" method="post">
            ...
            <center><input name="" id="" class="btn btn-success"  type="submit"value="Ingresar"></center>

           </form>

          </div>
          <div class="card-footer text-muted"style="background-color: gray"><br>
