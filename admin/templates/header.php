<?php
$url_base="http://localhost/myweb/admin/";
?>
<!doctype html>
<html lang="en">

<head>
  <title>Administrador del sitios web</title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
  ...
  <header>
    <nav class="navbar navbar-expand navbar-light bg-light">
        <div class="nav navbar-nav">
            ...
            <a class="nav-item nav-link" href="<?php echo $url_base;?>secciones/solicitud/">Solicitud</a>
